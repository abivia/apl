<?php
/* Driver template for the parser generator. (PHP port of LEMON)
*/
 ...
 */
class AP5L_Lang_Parser_Regex_yyToken implements ArrayAccess
{
    public $string = '';
    ...
    {
        if ($s instanceof AP5L_Lang_Parser_Regex_yyToken) {
            $this->string = $s->string;
            $this->metadata = $s->metadata;
        } else {
            $this->string = (string) $s;
            if ($m instanceof AP5L_Lang_Parser_Regex_yyToken) {
    ...
    function offsetSet($offset, $value)
    {
        if ($offset === null) {
            if (isset($value[0])) {
                $x = ($value instanceof AP5L_Lang_Parser_Regex_yyToken) ?
        ...
        if ($value instanceof AP5L_Lang_Parser_Regex_yyToken) {
            if ($value->metadata) {
 ...
 */
class AP5L_Lang_Parser_Regex_yyStackEntry
{
...
#line 5 "Parser.y"
class AP5L_Lang_Parser_Regex#line 107 "Parser.php"
{
...
#line 21 "Parser.y"
    ...
    {
        $this->result = new AP5L_Lang_LexerGenerator_ParseryyToken('');
        $this->_lex = $lex;
        $this->_subpatterns = 0;
...
*/
 ...
 /*  92 */ "recur ::= OPENASSERTION RECUR CLOSEPAREN",
     ...
     * @param AP5L_Lang_Parser_Regex_yyParser
     * @return int
     */
            ...
            if ($yyact >= self::YYNSTATE && $yyact < self::YYNSTATE + self::YYNRULE) {
                ...
                do {
                    ...
                    if ($nextstate < self::YYNSTATE) {
                        ...
                        $this->yyidx++;
                        $x = new AP5L_Lang_Parser_Regex_yyStackEntry;
                        $x->stateno = $nextstate;
    ...
    function yy_shift($yyNewState, $yyMajor, $yypMinor)
    {
        ...
        $yytos = new AP5L_Lang_Parser_Regex_yyStackEntry;
...
#line 56 "Parser.y"
    function yy_r1(){
    throw new AP5L_Lang_Exception('Cannot include start match "' .
...
#line 64 "Parser.y"
    function yy_r3(){
    throw new AP5L_Lang_Exception('Cannot include end match "' . $this->yystack[$this->yyidx + 0]->minor . '"');
    }
...
#line 68 "Parser.y"
    function yy_r5(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken($this->yystack[$this->yyidx + -2]->minor->string . '|' . $this->yystack[$this->yyidx + 0]->minor->string, array(
        'pattern' => $this->yystack[$this->yyidx + -2]->minor['pattern'] . '|' . $this->yystack[$this->yyidx + 0]->minor['pattern']));
    }
#line 1285 "Parser.php"
#line 84 "Parser.y"
    function yy_r17(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken($this->yystack[$this->yyidx + -1]->minor->string . $this->yystack[$this->yyidx + 0]->minor->string, array(
        'pattern' => $this->yystack[$this->yyidx + -1]->minor['pattern'] . $this->yystack[$this->yyidx + 0]->minor['pattern']));
    }
#line 1291 "Parser.php"
#line 123 "Parser.y"
    function yy_r28(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken('[' . $this->yystack[$this->yyidx + -1]->minor->string . ']', array(
...
#line 131 "Parser.y"
    function yy_r30(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken('[' . $this->yystack[$this->yyidx + -2]->minor->string . ']' . $this->yystack[$this->yyidx + 0]->minor, array(
...
#line 140 "Parser.y"
    function yy_r32(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken($this->yystack[$this->yyidx + 0]->minor, array(
...
#line 148 "Parser.y"
    function yy_r34(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken('\\\\' . $this->yystack[$this->yyidx + -2]->minor . '-' . $this->yystack[$this->yyidx + 0]->minor, array(
...
#line 160 "Parser.y"
    ...
    if (((int) substr($this->yystack[$this->yyidx + 0]->minor, 1)) > $this->_subpatterns) {
        throw new AP5L_Lang_Exception('Back-reference refers to non-existent ' .
    ...
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken('\\\\' . ($this->yystack[$this->yyidx + 0]->minor + $this->_patternIndex), array(
...
#line 170 "Parser.y"
    function yy_r38(){
    if (((int) substr($this->yystack[$this->yyidx + 0]->minor, 1)) > $this->_subpatterns) {
        throw new AP5L_Lang_Exception($this->yystack[$this->yyidx + 0]->minor . ' will be interpreted as an invalid' .
...
#line 179 "Parser.y"
    function yy_r39(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken($this->yystack[$this->yyidx + -1]->minor->string . '\\' . $this->yystack[$this->yyidx + 0]->minor, array(
...
#line 191 "Parser.y"
    function yy_r42(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken($this->yystack[$this->yyidx + -3]->minor->string . '\\\\' . $this->yystack[$this->yyidx + -2]->minor . '-\\' . $this->yystack[$this->yyidx + 0]->minor, array(
...
#line 207 "Parser.y"
    ...
    $this->yystack[$this->yyidx + 0]->minor = substr($this->yystack[$this->yyidx + 0]->minor, 1);
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken($this->yystack[$this->yyidx + -1]->minor->string . '\\\\' . ($this->yystack[$this->yyidx + 0]->minor + $this->_patternIndex), array(
...
#line 230 "Parser.y"
    function yy_r49(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken($this->yystack[$this->yyidx + -1]->minor . $this->yystack[$this->yyidx + 0]->minor, array(
...
#line 268 "Parser.y"
    ...
    // adjust back-reference for containing ()
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken('\\\\' . ($this->yystack[$this->yyidx + -1]->minor + $this->_patternIndex) . $this->yystack[$this->yyidx + 0]->minor, array(
...
#line 287 "Parser.y"
    function yy_r59(){
    if (((int) substr($this->yystack[$this->yyidx + -1]->minor, 1)) > $this->_subpatterns) {
        throw new AP5L_Lang_Exception($this->yystack[$this->yyidx + -1]->minor . ' will be interpreted as an invalid' .
...
#line 300 "Parser.y"
    function yy_r61(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken($this->yystack[$this->yyidx + -2]->minor->string . $this->yystack[$this->yyidx + -1]->minor . $this->yystack[$this->yyidx + 0]->minor, array(
...
#line 337 "Parser.y"
    ...
    $this->yystack[$this->yyidx + -1]->minor = substr($this->yystack[$this->yyidx + -1]->minor, 1);
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken($this->yystack[$this->yyidx + -2]->minor->string . '\\\\' . ($this->yystack[$this->yyidx + -1]->minor + $this->_patternIndex) . $this->yystack[$this->yyidx + 0]->minor, array(
...
#line 365 "Parser.y"
    function yy_r72(){
    throw new AP5L_Lang_Exception('Error: cannot set preg options directly with "' .
...
#line 383 "Parser.y"
    ...
    if ($this->yystack[$this->yyidx + -4]->minor != 'R') {
        if (!preg_match('/[1-9][0-9]*/', $this->yystack[$this->yyidx + -4]->minor)) {
            throw new AP5L_Lang_Exception('Invalid sub-pattern conditional: "(?(' . $this->yystack[$this->yyidx + -4]->minor . ')"');
        }
        if ($this->yystack[$this->yyidx + -4]->minor > $this->_subpatterns) {
            throw new AP5L_Lang_Exception('sub-pattern conditional . "' . $this->yystack[$this->yyidx + -4]->minor . '" refers to non-existent sub-pattern');
        }
    } else {
        throw new AP5L_Lang_Exception('Recursive conditional (?(' . $this->yystack[$this->yyidx + -4]->minor . ')" cannot work in this lexer');
    }
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken('(?(' . $this->yystack[$this->yyidx + -4]->minor . ')' . $this->yystack[$this->yyidx + -2]->minor->string . ')' . $this->yystack[$this->yyidx + 0]->minor, array(
...
#line 397 "Parser.y"
    ...
    if ($this->yystack[$this->yyidx + -3]->minor != 'R') {
        if (!preg_match('/[1-9][0-9]*/', $this->yystack[$this->yyidx + -3]->minor)) {
            throw new AP5L_Lang_Exception('Invalid sub-pattern conditional: "(?(' . $this->yystack[$this->yyidx + -3]->minor . ')"');
        }
        if ($this->yystack[$this->yyidx + -3]->minor > $this->_subpatterns) {
            throw new AP5L_Lang_Exception('sub-pattern conditional . "' . $this->yystack[$this->yyidx + -3]->minor . '" refers to non-existent sub-pattern');
        }
    } else {
        throw new AP5L_Lang_Exception('Recursive conditional (?(' . $this->yystack[$this->yyidx + -3]->minor . ')" cannot work in this lexer');
    }
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken('(?(' . $this->yystack[$this->yyidx + -3]->minor . ')' . $this->yystack[$this->yyidx + -1]->minor->string . ')', array(
        'pattern' => '(?(' . $this->yystack[$this->yyidx + -3]->minor . ')' . $this->yystack[$this->yyidx + -1]->minor['pattern'] . ')'));
    }
#line 1575 "Parser.php"
#line 411 "Parser.y"
    function yy_r78(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken('(?' . $this->yystack[$this->yyidx + -2]->minor->string . $this->yystack[$this->yyidx + -1]->minor->string . ')', array(
        'pattern' => '(?' . $this->yystack[$this->yyidx + -2]->minor['pattern'] . $this->yystack[$this->yyidx + -1]->minor['pattern'] . ')'));
    }
#line 1581 "Parser.php"
#line 415 "Parser.y"
    function yy_r79(){
    $this->_retvalue = new AP5L_Lang_LexerGenerator_ParseryyToken('(?' . $this->yystack[$this->yyidx + -3]->minor->string . $this->yystack[$this->yyidx + -2]->minor->string . ')' . $this->yystack[$this->yyidx + 0]->minor, array(
...
#line 419 "Parser.y"
    function yy_r80(){
    throw new AP5L_Lang_Exception('Look-behind assertions cannot be used: "(?<=' .
...
#line 446 "Parser.y"
    function yy_r86(){
    throw new AP5L_Lang_Exception('Cannot use named sub-patterns: "(' .
        $this->yystack[$this->yyidx + -2]->minor['pattern'] . ')');
    }
...
#line 1660 "Parser.php"
    ...
    function yy_reduce($yyruleno)
    {
        ...
        //AP5L_Lang_Parser_Regex_yyStackEntry $yymsp;            /* The top of the parser's stack */
