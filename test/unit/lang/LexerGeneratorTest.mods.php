 ...
 * @version $Id: LexerGeneratorTest.php,v 1.1 2007/11/22 04:43:52 instance Exp $
 */
...
//    }
    ...
    static function getPlexList() {
        ...
        foreach ($bugList as $bugNum => $testFile) {
            $bugList[$bugNum] = array($bugNum, $testFile);
        }
        return $bugList;
    }
     ...
     * what is expected.
     *
     * @dataProvider getPlexList
     */
    public function testLexerGeneratorParseBugFixes($bugNum, $plexFile) {
        $failMsg = '';
     ...
     *
     * @dataProvider getPhptList
     */
    public function testLexerGeneratorRunBugFixes($bugNum, $testFile) {
