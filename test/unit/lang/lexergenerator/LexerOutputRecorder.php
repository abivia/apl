 ...
 * @version $Id: LexerOutputRecorder.php 246683 2007-11-22 04:43:52Z instance $
 */
...
class LexerOutputRecorder
{
    ...
    function process($mode, $plex) {
        ...
        switch ($mode) {
            case 'data': {
                $lex = new AP5L_Lang_LexerGenerator_Lexer($plex);
            }
            break;

            case 'file': {
                $lex = new AP5L_Lang_LexerGenerator_Lexer(file_get_contents($plex));
